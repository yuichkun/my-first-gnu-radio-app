...
class myFirstHierBlock(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "myFirstHierBlock")
        ...
        # Connections
        ##################################################
        self.connect((self.FrequencyShifter_0, 0), (self.blocks_throttle2_1, 0))
        self.connect((self.analog_noise_source_x_0, 0), (self.low_pass_filter_1, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.low_pass_filter_1, 0), (self.FrequencyShifter_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, (self.samp_rate/4), (self.samp_rate/8), window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=myFirstHierBlock, options=None):
