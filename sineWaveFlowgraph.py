...
class sineWaveFlowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_char_to_float_2, 0), (self.qtgui_histogram_sink_x_1, 0))
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.blocks_char_to_float_1, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.blocks_char_to_float_2, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.blocks_pack_k_bits_bb_0, 0))
