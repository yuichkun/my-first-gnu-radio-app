...
class sineWaveFlowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_2 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100, 0.1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_streams_to_vector_0, 1))
        self.connect((self.analog_sig_source_x_2, 0), (self.qtgui_time_sink_x_2, 0))
