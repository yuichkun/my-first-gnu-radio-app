...
import pythonBlockTag_epy_block_0 as epy_block_0  # embedded python block
import pythonBlockTag_epy_block_1 as epy_block_1  # embedded python block
import sip



class pythonBlockTag(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pythonBlockTag")
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_add_const_vxx_1, 0), (self.single_pole_iir_filter_xx_0, 0))
        ...
        self.connect((self.blocks_tag_gate_0, 0), (self.qtgui_time_sink_x_3, 0))
...
def main(top_block_cls=pythonBlockTag, options=None):
