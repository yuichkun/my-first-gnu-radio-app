...
import pythonBlockMessagePassing_epy_block_0 as epy_block_0  # embedded python block
import pythonBlockMessagePassing_epy_block_1 as epy_block_1  # embedded python block
import sip



class pythonBlockMessagePassing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pythonBlockMessagePassing")
        ...
        # Connections
        ##################################################
        self.msg_connect((self.epy_block_1, 'messageOutput'), (self.blocks_message_debug_1, 'log'))
...
def main(top_block_cls=pythonBlockMessagePassing, options=None):
